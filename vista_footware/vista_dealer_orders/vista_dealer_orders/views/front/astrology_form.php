        ...
        <div class="col-lg-8">
            ...
            <form id="astrology_data">
                ...
                <!-- <div class="form-group">
                    <div class="input-group date date_timepicker" id="datetimepicker3" data-target-input="nearest">
                ...
                <input type="hidden" name="servicePrice" id="servicePrice" value="0">
                ...
                <div id="basic_info" style="display: none">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-5">
                            ...
                            <div class="input-group date date_timepicker" id="datetimepickerReqestor" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" name="hours" data-target="#datetimepickerReqestor" />
                                <div class="input-group-append" data-target="#datetimepickerReqestor" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-clock-o"></i></div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="partner_details" style="display: none">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-5">
                            <label>උපන් වෙලාව | Birth Time</label>
                            <div class="input-group date date_timepicker" id="datetimepickerPartner" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" name="phours"  data-target="#datetimepickerPartner" />
                                <div class="input-group-append" data-target="#datetimepickerPartner" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-clock-o"></i></div>
                                </div>
                            </div>
